...
const FName AVehicleAdvLockStepPawn::LookUpBinding("LookUp");
const FName AVehicleAdvLockStepPawn::LookRightBinding("LookRight");
const FName AVehicleAdvLockStepPawn::EngineAudioRPM("RPM");
...
AVehicleAdvLockStepPawn::AVehicleAdvLockStepPawn()
{
	...
	// Wheels/Tyres
	// Setup the wheels
	Vehicle4W->WheelSetups[0].WheelClass = UVehicleAdvLockStepWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("PhysWheel_FL");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UVehicleAdvLockStepWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("PhysWheel_FR");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 8.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UVehicleAdvLockStepWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("PhysWheel_BL");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -8.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UVehicleAdvLockStepWheelRear::StaticClass();
...
void AVehicleAdvLockStepPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("MoveForward", this, &AVehicleAdvLockStepPawn::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight", this, &AVehicleAdvLockStepPawn::MoveRight);
	PlayerInputComponent->BindAxis(LookUpBinding);
	PlayerInputComponent->BindAxis(LookRightBinding);

	PlayerInputComponent->BindAction("Handbrake", IE_Pressed, this, &AVehicleAdvLockStepPawn::OnHandbrakePressed);
	PlayerInputComponent->BindAction("Handbrake", IE_Released, this, &AVehicleAdvLockStepPawn::OnHandbrakeReleased);
	PlayerInputComponent->BindAction("SwitchCamera", IE_Pressed, this, &AVehicleAdvLockStepPawn::OnToggleCamera);
...
void AVehicleAdvLockStepPawn::EnableIncarView(const bool bState)
{
...
void AVehicleAdvLockStepPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void AVehicleAdvLockStepPawn::BeginPlay()
{
	Super::BeginPlay();
...
void AVehicleAdvLockStepPawn::OnResetVR()
{
#if HMD_MODULE_INCLUDED
...
void AVehicleAdvLockStepPawn::UpdateHUDStrings()
{
...
void AVehicleAdvLockStepPawn::SetupInCarHUD()
{
...
void AVehicleAdvLockStepPawn::UpdatePhysicsMaterial()
{
