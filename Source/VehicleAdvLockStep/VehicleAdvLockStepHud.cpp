...
AVehicleAdvLockStepHud::AVehicleAdvLockStepHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void AVehicleAdvLockStepHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if( bHMDDeviceActive == false )
	{
		...
		AVehicleAdvLockStepPawn* Vehicle = Cast<AVehicleAdvLockStepPawn>(GetOwningPawn());
